...
this.getModulos=function(){return $rootScope.CmsModulos;}});$app.service('MenuService',function($resource,$http){this.menu=function(){return itens=[{display:"HOME",href:"/",title:"Home",apelido:"home",itemParent:false},{display:"QUEM SOMOS",href:"/quem-somos",title:"Quem Somos",apelido:"quem-somos",itemParent:false},{display:"CONTATO",href:"/contato",title:"Contato",apelido:"contato",itemParent:false}];}
