  ...
  this.getComponenteTemplate = function(componente,tipo){
    switch(componente){
      ...
      case 'produto':
        switch(tipo){
          case 'unico-produto':
            return '<componente-unico-produto></componente-unico-produto>'
          break;
          case 'categoria-de-produto':
            return '<componente-categoria-produto></componente-categoria-produto>'
          break;
        }
      break;
      case 'evento':
        switch(tipo){
          case 'unico-evento':
            return '<componente-unico-evento></componente-unico-evento>'
          break;
          case 'categoria-de-evento':
            return '<componente-categoria-evento></componente-categoria-evento>'
          break;
        }
      break;
    }
