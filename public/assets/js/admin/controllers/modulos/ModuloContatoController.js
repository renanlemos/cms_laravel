$app.controller('ModuloContatoController',function($timeout,$scope,$rootScope,$resource,AuthService,ListDataService,CSRF_TOKEN){

	$scope.title = "Módulo Contato";
    ...
    $scope.window = {
    	new: function(){
            ...
            $scope.dataItem = {titulo:"",apelido:"",tipo:"contato",modulo_posicao_id:"",publicado:true,mostrar_titulo:0,tag_titulo:"h1",conteudo:"",parametros:{contato_id:"",class:"",id:""},ordem:""};
    ...
    create = function(){
        ...
        if(AuthService.checkCreate("modulo-contato",true) && AuthService.checkCreate("modulos",true)){
    ...
    update = function(){
        ...
        if(AuthService.checkUpdate("modulo-contato",true) && AuthService.checkUpdate("modulos",true)){
        	var request= $resource("/admin/modulos",{_token:CSRF_TOKEN},{
        		update: {method:"PUT"}
        	});
    ...
    $scope.delete = function(dataItem){
        ...
        if(AuthService.checkDelete("modulo-contato",true) && AuthService.checkDelete("modulos",true)){
    ...
    optionsGrid = function(){
        ...
        return $scope.optionsGrid = {
		    ...
		    type: "json",
		    transport:{ 
		      read: '/admin/modulos/grid?tipo=contato'
		    },
		    serpageSize: 10,
		    serverPaging: true, 
	...
	init = function(){
		...
		AuthService.checkView("modulo-contato");
