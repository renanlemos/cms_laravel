$app.controller('ModuloHtmlController',function($timeout,$scope,$rootScope,$resource,AuthService,ListDataService,CSRF_TOKEN){

	$scope.title = "Módulo Html";
    ...
    $scope.window = {
    	new: function(){
            ...
            $scope.dataItem = {titulo:"",apelido:"",tipo:"html",modulo_posicao_id:"",publicado:true,mostrar_titulo:0,tag_titulo:"h1",conteudo:"",parametros:{class:"",id:""},ordem:""};
    ...
    create = function(){
        ...
        if(AuthService.checkCreate("modulo-html",true) && AuthService.checkCreate("modulos",true)){
    ...
    update = function(){
        ...
        if(AuthService.checkUpdate("modulo-html",true) && AuthService.checkUpdate("modulos",true)){
        	var request= $resource("/admin/modulos",{_token:CSRF_TOKEN},{
        		update: {method:"PUT"}
        	});
    ...
    $scope.delete = function(dataItem){
        ...
        if(AuthService.checkDelete("modulo-html",true) && AuthService.checkDelete("modulos",true)){
    ...
    optionsGrid = function(){
        ...
        return $scope.optionsGrid = {
		    ...
		    type: "json",
		    transport:{ 
		      read: '/admin/modulos/grid?tipo=html'
		    },
		    serpageSize: 10,
		    serverPaging: true, 
	...
	init = function(){
		...
		AuthService.checkView("modulo-html");
