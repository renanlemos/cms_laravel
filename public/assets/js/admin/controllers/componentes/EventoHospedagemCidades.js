$app.controller('EventoHospedagemCidadesController',function($timeout,$scope,$rootScope,$resource,AuthService,ListDataService,CSRF_TOKEN){

	$scope.title = "Cidades de Hospedagem";
    ...
    $scope.window = {
    	...
    	edit: function(dataItem){
    		...
    		$scope.formAction = "update()";
    		 $scope.modal.setOptions({
    	    	title: "Editar Cidade: "+dataItem.id
            });
    ...
    create = function(){
        if(AuthService.checkCreate("componente-eventos",true) && AuthService.checkCreate("hospedagem",true) && AuthService.checkCreate("componente-evento-hospedagem-cidades",true) && AuthService.checkCreate("componentes",true)){
          	var request = $resource("/admin/componentes/eventos/evento-hospedagem-cidades",{_token:CSRF_TOKEN});
    ...
    update = function(){
        ...
        if(AuthService.checkUpdate("componente-eventos",true) && AuthService.checkUpdate("hospedagem",true) && AuthService.checkUpdate("componente-evento-hospedagem-cidades",true) && AuthService.checkUpdate("componentes",true)){
        	var request= $resource("/admin/componentes/eventos/evento-hospedagem-cidades",{_token:CSRF_TOKEN},{
        		update: {method:"PUT"}
        	});
    ...
    $scope.delete = function(dataItem){
        ...
        if(AuthService.checkDelete("componente-eventos",true) && AuthService.checkDelete("hospedagem",true) && AuthService.checkDelete("componente-evento-hospedagem-cidades",true) && AuthService.checkDelete("componentes",true)){
            if(confirm("Deseja deletar esse(s) registro(s)?")){
            	...
            	var request= $resource("/admin/componentes/eventos/evento-hospedagem-cidades");
    ...
    optionsGrid = function(){
        ...
        return $scope.optionsGrid = {
		    ...
		    type: "json",
		    transport:{ 
		      read: '/admin/componentes/eventos/evento-hospedagem-cidades/grid'
		    },
		    serpageSize: 10,
		    serverPaging: true, 
    ...
    init = function(){
        ...
        AuthService.checkView("componente-evento-hospedagem-cidades");
